const iconProps = (size = 24) => ({ width: size, height: size, fill: 'none', strokeWidth: 1.8, strokeLinecap: 'round', strokeLinejoin: 'round', viewBox: '0 0 24 24' });

export const WrenchIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg {...iconProps(size)} stroke={color} {...props}>
    <path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z" />
  </svg>
);

export const DropletIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg {...iconProps(size)} stroke={color} {...props}>
...
export const PhoneIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg {...iconProps(size)} stroke={color} {...props}>
    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.4 2 2 0 0 1 3.58 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.96a16 16 0 0 0 6.13 6.13l1.27-.9a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
  </svg>
);
...
export const StarIcon = ({ size = 24, color = 'currentColor', filled = false, ...props }) => (
  <svg {...iconProps(size)} stroke={color} fill={filled ? color : 'none'} {...props}>
...
export const ThumbsUpIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg {...iconProps(size)} stroke={color} {...props}>
...
export const ToolIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg {...iconProps(size)} stroke={color} {...props}>
...
export const AwardIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg {...iconProps(size)} stroke={color} {...props}>
